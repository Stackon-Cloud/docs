...
- **Auto-Generated RESTful APIs:** Instant creation of REST endpoints for your data models, complete with Swagger
  documentation for easy integration.
- **Built-In Authentication:** Secure user management powered by Keycloack, supporting email/password login and more,
  ensuring your app is secure from day one.
...
Ready to experience the ease of Stack on Cloud? Visit our landing page and join the waiting list to be among the first
to try our platform:

- [Stack on Cloud](https://stackon.cloud)

## Documentation

For more detailed information on how to use Stack on Cloud, please refer to our documentation (coming soon):

- [Documentation](https://stackon.cloud/documentation)
